...
Original file is located at
    https://colab.research.google.com/drive/1l_KUZqTQCLrkyoY5sfSMogdvmTFSwEZX?usp=sharing
"""
...
data.drop(['ID','pickup+AF8-time','drop+AF8-time','pickup+AF8-loc','drop+AF8-loc'], axis=1, inplace=True)
