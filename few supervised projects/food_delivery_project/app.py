...
def load_model_and_encoder():
    with open(r"C:\Users\user\Desktop\PROJECT_FILE\stored_model.pkl", 'rb') as model_file:
        model = pickle.load(model_file)
    with open(r'C:\Users\user\Desktop\PROJECT_FILE\stored_encoder.pkl', 'rb') as encoder_file:
        encoder = pickle.load(encoder_file)
    with open(r'C:\Users\user\Desktop\PROJECT_FILE\stored_scaler.pkl', 'rb') as scaler_file:
...
def main():
    ...
    st.title('PREDICTION FOR OLA  bike LOGISTICS APP')
    ...
    distance = st.sidebar.number_input('Distance (miles)', min_value=0.0, max_value=100.0, step=0.1)
